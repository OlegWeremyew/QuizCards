import { EMPTY_ARRAY, EMPTY_OBJECT, EMPTY_STRING } from 'constants/variables';
import {
  CHANGE_CURRENT_PAGE,
  SET_DEBOUNCING_FLAG,
  SET_FILTERED_PACKS,
...
import {
  CardsPackActionReducerType,
  InitialCardsPackStateType,
} from 'Redux/cardsPackReducer/types';
...
export const cardsPackReducer = (
  state: InitialCardsPackStateType = initialCardsPackState,
  action: CardsPackActionReducerType,
): InitialCardsPackStateType => {
  switch (action.type) {
    case SET_PACKS_LIST:
